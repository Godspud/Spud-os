...
font_path=os.path.join("C:/Users/Troy/Downloads/coding/spud_os","Fonts/OpenDyslexicMono-Regular.otf")
                ...
                if inpu == '1':
                    ...
                    for counter in range(33,127):
                        if font.size(chr(counter))[1] > largest_char_y:
                             largest_char_y=font.size(chr(counter))[1]
                    char_y=largest_char_y
                    list_of_files=os.listdir('C:/Users/Troy/Downloads/coding/spud_os/Fonts')
                    list_of_files_2=[]
                    for counter in range(len(list_of_files)):
                        list_of_files_2.append((str(counter+1)+'. '+list_of_files[counter]))
                    inpu=screen_input('\n'.join(list_of_files_2))
                    try:
                        font_path=os.path.join('C:/Users/Troy/Downloads/coding/spud_os/Fonts',list_of_files[int(inpu)-1])
                        font=pygame.font.Font(font_path,48)
